...
class Group
{
	 ...
	 * @return string The decrypted password if the entry exists inside this group or a sub-group, null otherwise.
	 */
	 ...
	 * whose uuid is $uuid.
	 * @param string $uuid An entry uuid in base64.
	 * @return array|null A list of custom fields if the entry exists inside this group
	 ...
	 * @param static|null $group A Group instance, possibly null (it is then ignored).
	 */
	 ...
	 * @param Entry|null $entry An Entry instance, possibly null (it is then ignored).
	 */
	 ...
	 *                the array.
	 * @return array An array containing this group.
	 */
	 ...
	 * @return static|null A Group instance if the parsing went okay, null otherwise.
	 */
