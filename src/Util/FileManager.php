...
class FileManager
{
     ...
     * @param bool   $filesonly Whether only files must be used.
     * @param bool   $memonly   Whether only memory must be used.
     */
     ...
     * @param bool   $writeable Whether this value can be written on disk.
     * @param bool   $override  Whether to override an already existing file.
     *
     * @throws Exception If this FileManager directory is not accessible.
     *
     * @return string|null The hash of $key, or null in case of error.
     */
    public function addWithKey(
        $key,
        $value,
     ...
     * @throws Exception If this FileManager directory is not accessible.
     *
     * @return bool if $key already exists, false otherwise.
     */
     ...
     * @throws Exception If this FileManager directory is not accessible.
     *
     * @return bool if $h already exists, false otherwise.
     */
     ...
     * @throws Exception If this FileManager directory is not accessible.
     *
     * @return string|null A string value, or null if $key does not exist.
     */
     ...
     * @throws Exception If this FileManager directory is not accessible.
     *
     * @return string|null A string value, or null if $h does not exist.
     */
     ...
     * @throws Exception If this FileManager directory is not accessible.
     *
     * @return string A filename, or null if the value does not exist or is not stored in a file.
     */
     ...
     * @throws Exception If this FileManager directory is not accessible.
     *
     * @return bool if the element existed and could be removed.
     */
     ...
     * @throws Exception If this FileManager directory is not accessible.
     *
     * @return array|null An array, or null if the key $key does not exist.
     */
     ...
     * @throws Exception If this FileManager directory is not accessible.
     *
     * @return array|null An array, or null if the hash $h does not exist.
     */
     ...
     * @param bool   $writeable Whether the file can be written on disk.
     * @param bool   $override  Whether to override an already existing file.
     *
     * @throws Exception If this FileManager directory is not accessible.
     *
     * @return bool if the element was correctly added or already exists, and false otherwise.
     */
    protected function addElement($h, $v, $ext, $writeable, $override)
    {
        ...
        if ($writeable && $this->acceptFiles) {
            ...
            if ($this->saveFile($filename, $v)) {
                ...
                $this->elements[$h] = [self::TYPE_FILE, $filename];

                return true;
            }
        }
        if ($this->acceptMem) {
            $this->elements[$h] = [self::TYPE_MEM,
     ...
     *
     * @return bool in case of success, or false otherwise.
     */
