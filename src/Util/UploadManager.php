...
class UploadManager extends FileManager
{
     ...
     * @param bool   $writeable Whether this file can be written on disk.
     * @param bool   $override  Whether to override an already existing file.
     *
     * @return string|null The hash of the file, or null in case of error.
     */
    public function add(
        $value,
     ...
     * @paramstring  $v The uploaded file temporary path.
     *
     * @param string $ext       The final file extension.
     ...
     *
     * @return bool if the file was successfully added to the collection or if
